...
if(isset($_POST['reg']))
{
	...
	else
	{
		...
		if(!empty($name) && !empty($email) && !empty($phone) && !empty($pass) && !empty($uimage))
		{
			...
			$sql="INSERT INTO user (uname,uemail,uphone,upass,utype,uimage) VALUES ('$name','$email','$phone','$hash','$utype','$uimage')";
                        ...
                        <div class="login-right">
							<div class="login-right-wrap">
								...
								<form method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<input type="tel"  name="phone" class="form-control" placeholder="Your Phone*" onkeypress="return validateNumber(event)" maxlength="10">
									</div>
									<div class="form-group">
