        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
					...
					<?php
						$id=$_REQUEST['pid']; 
                        $sql = "SELECT property.*, user.* FROM `property`,`user` WHERE property.uid=user.uid and pid='$id'";
                        ...
                        <div class="property-details">
                            ...
                            <div class="accordion" id="accordionExample">
                                ...
                                <div id="collapseTwo" class="collapse p-4" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                    <img src="admin/property/<?php echo $row['topmapimage'];?>" alt="Not Available"> </div>
                                ...
                                <div id="collapseThree" class="collapse p-4" aria-labelledby="headingThree" data-parent="#accordionExample">
                                    <img src="admin/property/<?php echo $row['groundmapimage'];?>" alt="Not Available"> </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-widget mt-5">
                            ...
                            <ul class="property_list_widget">
								...
								<?php 
                                $sql = "SELECT * FROM `property` ORDER BY date DESC LIMIT 7";
								$query=mysqli_query($conn, $sql);
										while($row=mysqli_fetch_array($query))
										{
								?>
