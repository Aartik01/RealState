                                        ...
                                        <div class="col-md-4 col-lg-2">
                                            <div class="form-group">
                                                <select class="form-control" name="price">
                                                    ...
                                                    <option value="rent">100000 - 100000</option>
                                                    <option value="sale">100000 - 200000</option>
                                                    <option value="sale">200000 - 300000</option>
                                                    <option value="sale">300000 - 400000</option>
                                                    <option value="sale">400000 - 500000</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <ul class="nav property-btn float-right" id="pills-tab" role="tablist">
                                <li class="nav-item"> <a class="nav-link py-3 active" id="pills-home-tab"
                                        data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home"
                                        aria-selected="true">New</a> </li>
                                <li class="nav-item"> <a class="nav-link py-3" id="pills-profile-tab" data-toggle="pill"
                                        href="#pills-profile" role="tab" aria-controls="pills-profile"
                                        aria-selected="false">Featured</a> </li>
                                <li class="nav-item"> <a class="nav-link py-3" id="pills-contact-tab2"
                                        data-toggle="pill" href="#pills-contact" role="tab"
                                        aria-controls="pills-contact" aria-selected="false">Top Sale</a> </li>
                                <li class="nav-item"> <a class="nav-link py-3" id="pills-contact-tab3"
                                        data-toggle="pill" href="#pills-resturant" role="tab"
                                        aria-controls="pills-contact" aria-selected="false">Best Sale</a> </li>
                            </ul>
                        </div>
                        <div class="col-md-12">
                            <div class="tab-content mt-4" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <?php
                                        $sql = "SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid ORDER BY date DESC LIMIT 9";
                                            ...
                                            <div class="col-md-6 col-lg-4">
                                                <div class="featured-thumb hover-zoomer mb-4">
                                                    <div class="overlay-black overflow-hidden position-relative"> <img
                                                            src="admin/property/<?php echo $row['pimage']; ?>" alt="pimage">
                                                        <div class="featured bg-success text-white">New</div>
                                                        <div class="sale bg-success text-white text-capitalize">For
                                                            <?php echo $row['stype']; ?></div>
                                                        <div class="price text-primary"><b>$<?php echo $row['price']; ?>
                                                            </b><span class="text-white"><?php echo $row['size']; ?>
                                                                Sqft</span></div>
                                                    </div>
                                                    <div class="featured-thumb-data shadow-one">
                                                        <div class="p-3">
                                                            <h5
                                                                ...
                                                                <a
                                                                    href="propertydetail.php?pid=<?php echo $row['pid']; ?>"><?php echo $row['title']; ?></a>
                                                            </h5>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i
                                    ...
                                    <?php
                                    $sql = "SELECT count(pid) FROM property";
                                    $query = mysqli_query($conn, $sql);
                                    while ($row = mysqli_fetch_array($query)) {
                                        ?>
                            ...
                            <div class="col-md-3">
                                <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i
                                        class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                    <?php
                                    $sql = "SELECT count(pid) FROM property where stype='sale'";
                                    $query = mysqli_query($conn, $sql);
                                    while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                        <div class="count-num text-success my-4" data-speed="3000"
                            ...
                            <div class="col-md-3">
                                <div class="count wow text-center  mb-sm-50" data-wow-duration="300ms"> <i
                                        class="flaticon-house flat-large text-white" aria-hidden="true"></i>
                                    <?php
                                    $sql = "SELECT count(pid) FROM property where stype='rent'";
                                    $query = mysqli_query($conn, $sql);
                                    while ($row = mysqli_fetch_array($query)) {
                                        ?>
                                        <div class="count-num text-success my-4" data-speed="3000"
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $sql = "SELECT count(state), property.* FROM property where city='Noida'";
                                        $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)) {
                                            ?>
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $sql = "SELECT count(state), property.* FROM property where city='Bhopal'";
                                        $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)) {
                                            ?>
                                            <h4 class="hover-text-success text-capitalize"><a
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $sql = "SELECT count(state), property.* FROM property where city='Shimla'";
                                        $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)) {
                                            ?>
                                            <h4 class="hover-text-success text-capitalize"><a
                            ...
                            <div class="col-md-6 col-lg-3 pb-1">
                                <div
                                    ...
                                    <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                        <?php
                                        $sql = "SELECT count(state), property.* FROM property where city='Manali'";
                                        $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)) {
                                            ?>
                                            <h4 class="hover-text-success text-capitalize"><a
                            ...
                            <div class="content-sidebar p-4">
                                <div class="mb-3 col-lg-12">
                                    ...
                                    <div class="recent-review owl-carousel owl-dots-gray owl-dots-hover-success">
                                        ...
                                        <?php
                                        // $sql = "select feedback.*, user.* from feedback,user where feedback.uid=user.uid and feedback.status='1'";
                                        $sql = "select feedback.*, user.* from feedback,user where feedback.uid=user.uid";
                                        $query = mysqli_query($conn, $sql);
                                        while ($row = mysqli_fetch_array($query)) {
                                            ?>
                                            <div class="item">
                                                <div class="p-4 bg-success down-angle-white position-relative">
                                                    <p class="text-white"><i
                                                            class="fas fa-quote-left mr-2 text-white"></i><?php echo $row['fdescription']; ?>.
